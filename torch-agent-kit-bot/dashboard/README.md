...
- **Runs**: JSON files from **`../runs`** (i.e. `torch-agent-kit-bot/runs/`) generated by the bot runner (`npm run daily:agentkit`, scheduled at 12:00 UTC). No database; no blockchain writes.
